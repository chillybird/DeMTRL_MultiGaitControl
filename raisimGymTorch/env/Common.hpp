...
using EigenRowMajorBoolMat=Eigen::Matrix<bool, -1, -1, Eigen::RowMajor>;
using EigenVec=Eigen::Matrix<Dtype, -1, 1>;
using EigenBoolVec=Eigen::Matrix<bool, -1, 1>;

//using EigenVecMat = Eigen::Matrix<Eigen::MatrixXd, -1, -1>;
//using MatrixBoolXd = Eigen::Matrix<bool, -1, -1>;
//using EigenVecBoolMat = Eigen::Matrix<MatrixBoolXd, -1, -1>;
